...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int CHECK_SETTINGS_CODE = 333;
    ...
    private void requestLocationPermission() {
        ...
        boolean shouldProvideRationable = ActivityCompat.shouldShowRequestPermissionRationale(
                this , Manifest.permission.ACCESS_FINE_LOCATION);

        if (shouldProvideRationable) {

            showSnackBar(
                    "Location permission is needed for add functionality",
                    "OK",
